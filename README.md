...
1. 📥 **Download** the firmware **ZIP file** from this repository: [Firmware.zip](github.com/LauraFatta/TinyMLPeopleCounter/blob/main/crowd-counting-open-mv-fw-v10.zip])
